...
const int *mg_pesto_tables[6] = {mg_pawn_table,   mg_knight_table,
                                 mg_bishop_table, mg_rook_table,
                                 mg_queen_table,  mg_king_table};
const int *eg_pesto_tables[6] = {eg_pawn_table,   eg_knight_table,
...
int evaluate_board_pesto(const Board &board) { return evaluate_board(board); }
