...
void update_continuation_history(const Board& board, const Move& currentMove, int depth, const Move badQuiets[256], const int& badQuietCount); // Update continuation history
